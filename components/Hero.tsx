...
const Hero = () => {
  ...
  return (
    <section className='relative w-full min-h-[90vh] flex flex-col justify-center items-start overflow-hidden py-5 px-6'>
      ...
      >
        ...
        <motion.h1 
          variants={item}
          className='text-5xl md:text-6xl font-bold max-w-4xl tracking-tight leading-[1.1]'
        >
  ...
  <span className="text-transparent bg-clip-text bg-linear-to-r from-indigo-300 via-indigo-400 to-purple-500">
    Full-Stack Applications.
        ...
        >
          Full Stack Developer specialized in MERN Stack, Next.js & System Design.
        </motion.p>

        {/* الأزرار */}
        <motion.div variants={item} className='flex flex-wrap gap-6'>
        <Button className='w-fit text-xl text-white bg-linear-30 from-indigo-700 to-indigo-400 border-0 py-6 px-8'>Get Started</Button>
        <Button className='w-fit text-xl bg-white/0 text-white border-indigo-300/40 border py-6 px-8'>Learn More <ArrowUpRightIcon/></Button>
        </motion.div>
      </motion.div>
